...
void PARTICLE_OT_modifier_add(struct wmOperatorType *ot);
void PARTICLE_OT_modifier_remove(struct wmOperatorType *ot);
void PARTICLE_OT_modifier_move_up(struct wmOperatorType *ot);
void PARTICLE_OT_modifier_move_down(struct wmOperatorType *ot);
