...
const NodeGraph::Output *NodeGraph::add_output(const string &name, const string &type, NodeConstant *default_value)
{
...
NodeInstance *NodeGraph::add_proxy(const TypeDesc &td, NodeConstant *default_value)
{
