...
#define BVM_DEFINE_OPCODES_BASE \
	...
	DEF_OPCODE(SET_MATRIX44) \
	DEF_OPCODE(GET_ELEM_MATRIX44) \
	\
	DEF_OPCODE(GET_DERIVATIVE_FLOAT) \
	DEF_OPCODE(GET_DERIVATIVE_FLOAT3) \
	DEF_OPCODE(GET_DERIVATIVE_FLOAT4) \
...
/*************************************/
#define BVM_DEFINE_OPCODES_MESH \
	DEF_OPCODE(MESH_LOAD) \
	DEF_OPCODE(MESH_LOAD_OBJECT) \
