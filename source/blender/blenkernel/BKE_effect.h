...
typedef struct EffectorCache {
	...
	/* gravity vector for estimating pressure */
	float gravity[3];
...
int closest_point_on_surface(struct SurfaceModifierData *surmd, const float co[3],
                             float surface_co[3], float surface_nor[3], float surface_vel[3]);
int raycast_point_on_surface(struct SurfaceModifierData *surmd, const float co[3], const float dir[3],
                             float surface_co[3], float surface_nor[3], float surface_vel[3]);
