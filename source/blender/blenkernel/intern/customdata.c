...
const CustomDataMask CD_MASK_MESH =
    ...
    CD_MASK_PROP_FLT | CD_MASK_PROP_INT | CD_MASK_PROP_STR | CD_MASK_PROP_FLT3 | CD_MASK_PROP_FLT4 |
    CD_MASK_MDISPS | CD_MASK_MLOOPUV | CD_MASK_MLOOPCOL | CD_MASK_MPOLY | CD_MASK_MLOOP |
...
const CustomDataMask CD_MASK_EDITMESH =
    ...
    CD_MASK_MCOL | CD_MASK_PROP_FLT | CD_MASK_PROP_INT | CD_MASK_PROP_STR | CD_MASK_PROP_FLT3 | CD_MASK_PROP_FLT4 |
...
const CustomDataMask CD_MASK_DERIVEDMESH =
    ...
    CD_MASK_MCOL | CD_MASK_PROP_FLT | CD_MASK_PROP_INT | CD_MASK_PROP_FLT3 | CD_MASK_PROP_FLT4 | CD_MASK_CLOTH_ORCO |
...
const CustomDataMask CD_MASK_BMESH =
    ...
    CD_MASK_MSTICKY | CD_MASK_MDEFORMVERT | CD_MASK_PROP_FLT | CD_MASK_PROP_INT | CD_MASK_PROP_FLT3 | CD_MASK_PROP_FLT4 |
...
const CustomDataMask CD_MASK_EVERYTHING =
    ...
    CD_MASK_PROP_FLT3 | CD_MASK_PROP_FLT4 | CD_MASK_PROP_INT | CD_MASK_PROP_STR |
    CD_MASK_ORIGSPACE | CD_MASK_ORCO | CD_MASK_MTEXPOLY | CD_MASK_MLOOPUV |
