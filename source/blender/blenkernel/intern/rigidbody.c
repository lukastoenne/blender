...
static void rigidbody_world_build_particle_systems(Scene *UNUSED(scene), RigidBodyWorld *rbw, bool rebuild)
{
	GroupObject *go;
...
static void rigidbody_world_build(Scene *scene, RigidBodyWorld *rbw, int rebuild)
{
	...
	rigidbody_world_build_particle_systems(scene, rbw, rebuild);
