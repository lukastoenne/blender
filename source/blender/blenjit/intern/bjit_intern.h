...
const char *bjit_get_external_function_name(llvm::Function *func);
bool bjit_function_is_external(const llvm::Function *func);
llvm::Function *bjit_find_external_function(llvm::Module *mod, const std::string &name);
